...
const setExtSearchKeyValue = inject<SetSearchKey | undefined>("mcSetExternalSearchKeyValue") // for other component using datatable
const setExtSearchItemsCount = inject<SetNumber | undefined>("mcSetExternalSearchItemsCount") // for other component using datatable

const setExtSearchKey = (val: string) => {
  setExtSearchKeyValue && setExtSearchKeyValue(val)
}
const setExtSItemsCount = (val: number) => {
  setExtSearchItemsCount && setExtSearchItemsCount(val)
}
...
watch([searchItemsCount], ([val]) => {
  setExtSItemsCount(val)
}, {immediate: true})
